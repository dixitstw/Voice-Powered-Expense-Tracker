        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} className={classes.gridItem}>
            <div className={classes.financialSummaryCentered}>
              <Typography
                ...
                style={{ fontWeight: "600", fontFamily: "Merriweather" }}
              >
                Financial Summary
              </Typography>
              <div className={classes.summaryItem}>
                ...
                <Typography variant="body1">
                  Total Expense:
                  <span
                    className={classes.summaryHighlight}
                    style={{ color: "#ff6b6b" }}
                  >
          ...
          <Grid item xs={12} md={6} className={classes.gridItem}>
            <div className={classes.incomeCategory}>
              ...
              {financialMetrics.topIncomeCategories.map(
                ([category, amount]) => (
                  <Typography
                    key={category}
                    variant="body1"
          ...
          <Grid item xs={12} md={6} className={classes.gridItem}>
            <div className={classes.expenseCategory}>
              ...
              {financialMetrics.topExpenseCategories.map(
                ([category, amount]) => (
                  <Typography
                    key={category}
                    variant="body1"
